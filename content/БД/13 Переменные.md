...
Время жизни: с момента объявления до конца выполнения процедуры, где объявлена, или [[Базы данных. Определения#Батч|батча]]
...
Глобальные переменные начинаются с двух символов @@ (хотя в [документации](https://learn.microsoft.com/ru-ru/sql/t-sql/language-elements/variables-transact-sql?view=sql-server-ver16) они называются функциями)
