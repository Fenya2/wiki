...
Автоматом [[LR(1)-пункт|LR(1)-пунктов]] [[Расширенная грамматика|расширенной грамматики]] $G = (\Sigma, \Gamma, P, S')$ называется [[Неполный недерменированный конечный автомат с эпсилон переходами|неполный эпсилон-НКА]] $(Q, \Sigma \cup \Gamma, \delta, q_0, Q)$, где  
