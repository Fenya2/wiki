...
>Терминалы выводят сами себя, поэтому считается, что $a \in FIRST(a), a \in \Sigma$ (также следует из 1 пункта)

> Пустая строка выводит сама себя, поэтому считается, что $\epsilon \in FIRST(\epsilon)$

>По определению множество FIRST может состоять только из терминалов и пустого слова
